                    ...
                    <div className="col-lg-4 p-0 shadow">
                        ...
                        <div className="wizard pt-3">
                            <div class="d-flex align-items-start">
                                <div class="nav align-items-start flex-column col-12 nav-pills me-3"
                                id = 'v-pills-tab'
                                role= 'tablist'
                                ...
                                >
                                    ...
                                    <button id="v-pills-profile-tab" class="nav-link d-flex justify-content-between"
                                    data-bs-toggle = 'pill'
